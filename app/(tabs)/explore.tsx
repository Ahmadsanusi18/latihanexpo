      ...
      <ThemedView style={styles.content}>
        ...
        <ThemedView style={styles.section}>
          ...
          <ThemedView style={styles.infoRow}>
            ...
            <ThemedText style={styles.infoText}>Ahmad Sanusi</ThemedText>
          </ThemedView>
          
          {/* Baris informasi NIM */}
          <ThemedView style={styles.infoRow}>
            <ThemedText style={styles.emojiSmall}>🔢</ThemedText>
            <ThemedText style={styles.infoText}>082135578589</ThemedText>
          </ThemedView>
          
          {/* Baris informasi program studi */}
          <ThemedView style={styles.infoRow}>
            <ThemedText style={styles.emojiSmall}>🎓</ThemedText>
            <ThemedText style={styles.infoText}>Informatika</ThemedText>
          </ThemedView>
        </ThemedView>
